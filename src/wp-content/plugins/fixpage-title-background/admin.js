var FixPageBackgroundMediaUploader, FixPageSetBackgroundHTML, FixPageRemoveBackground, FixPageSetAsBackground;

(function($) {

  FixPageBackgroundMediaUploader = function(options) {
    var self = this, frame = wp.media.frames.file_frame;
  ...
  FixPageSetBackgroundHTML = function(html) {
    $('.inside', '#postbackgrounddiv').html(html);
  };

  FixPageRemoveBackground = function(id, nonce) {
    $.post(ajaxurl, {
      ...
      if (str == '0') {
        ...
        FixPageSetBackgroundHTML(str);
      }
    }
    );
  };

  FixPageSetAsBackground = function(background_id, id, nonce) {
    ...
    $.post(ajaxurl, {
      ...
      if (str == '0') {
        ...
        $link.fadeOut(2000);
        win.FixPageSetBackgroundHTML(str);
      }
    }
    );
  };
